...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UGameLiftClientObject_CreateGameLiftObject_Statics::Function_MetaDataParams[] = {
		...
		{ "Comment", "/**\n\x09* public static UGameLiftClientObject::CreateGameLiftObject\n\x09* Creates a GameLiftClientObject. This function must be called first before accessing any GameLift client functions.\n\x09* @param AccessKey [const FString&] AccessKey of your AWS user. @See http://docs.aws.amazon.com/general/latest/gr/managing-aws-access-keys.html\n\x09* @param Secret [const FString&] SecretKey of your AWS user. @See http://docs.aws.amazon.com/general/latest/gr/managing-aws-access-keys.html\n\x09* @param Region [const FString&] Default is set to us-east-1 (North Virginia).\n\x09* @param bUsingGameLiftLocal [bool] If true, then it is assumed you are using GameLift Local. @See http://docs.aws.amazon.com/gamelift/latest/developerguide/integration-testing-local.html#integration-testing-local-server\n\x09* @param LocalPort [int32] port to use if bUsingGameLiftLocal is true.\n\x09* @return [UGameLiftClientObject*] Returns UGameLiftClientObject*. Use this to create game sessions, player sessions etc.\n\x09**/" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UGameLiftClientObject_CreateGameSession_Statics::Function_MetaDataParams[] = {
		{ "Category", "GameLift Client Object" },
		{ "Comment", "/**\n\x09* public UGameLiftClientObject::CreateGameSession\n\x09* Creates a multi player game session for players.\n\x09* This action creates a game session record and assigns an available server process in the specified fleet to host the game session. \n\x09* A fleet must have an ACTIVE status before a game session can be created in it.\n\x09* From the return value first bind both success and fail events and then call Activate to create game session.\n\x09* @param GameSessionProperties [FGameLiftGameSessionConfig] Settings for the game session you want to create.\n\x09* @return [UGameLiftCreateGameSession*] Returns UGameLiftCreateGameSession* Object.\n\x09**/" },
		{ "ModuleRelativePath", "Public/GameLiftClientObject.h" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UGameLiftClientObject_CreateGameSession_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UGameLiftClientObject, nullptr, "CreateGameSession", nullptr, nullptr, sizeof(GameLiftClientObject_eventCreateGameSession_Parms), Z_Construct_UFunction_UGameLiftClientObject_CreateGameSession_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UGameLiftClientObject_CreateGameSession_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UGameLiftClientObject_CreateGameSession_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UGameLiftClientObject_CreateGameSession_Statics::Function_MetaDataParams)) };
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UGameLiftClientObject_CreatePlayerSession_Statics::Function_MetaDataParams[] = {
		{ "Category", "GameLift Client Object" },
		{ "Comment", "/**\n\x09* public UGameLiftClientObject::CreatePlayerSession\n\x09* Adds a player to a game session and creates a player session record. \n\x09* Before a player can be added, a game session must have an ACTIVE status, have a creation policy of ALLOW_ALL, and have an open player slot.\x09\n\x09* From the return value first bind both success and fail events and then call Activate to create player session.\n\x09* @param GameSessionID [FString] Unique identifier for the game session to add a player to.\n\x09* @param UniquePlayerID [FString] Unique identifier for a player. Player IDs are developer-defined.\n\x09* @return [UGameLiftCreatePlayerSession*] Returns UGameLiftCreatePlayerSession* Object.\n\x09**/" },
		{ "ModuleRelativePath", "Public/GameLiftClientObject.h" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UGameLiftClientObject_CreatePlayerSession_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UGameLiftClientObject, nullptr, "CreatePlayerSession", nullptr, nullptr, sizeof(GameLiftClientObject_eventCreatePlayerSession_Parms), Z_Construct_UFunction_UGameLiftClientObject_CreatePlayerSession_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UGameLiftClientObject_CreatePlayerSession_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UGameLiftClientObject_CreatePlayerSession_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UGameLiftClientObject_CreatePlayerSession_Statics::Function_MetaDataParams)) };
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UGameLiftClientObject_DescribeGameSession_Statics::Function_MetaDataParams[] = {
		{ "Category", "GameLift Client Object" },
		{ "Comment", "/**\n\x09* public UGameLiftClientObject::DescribeGameSession\n\x09* Retrieves the given game session.\n\x09* From the return value first bind both success and fail events and then call Activate to describe game session.\n\x09* @param GameSessionID [FString] Game Session ID. This can be obtained after a successful create game session.\n\x09* @return [UGameLiftDescribeGameSession*] Returns UGameLiftDescribeGameSession* Object.\n\x09**/" },
		{ "ModuleRelativePath", "Public/GameLiftClientObject.h" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UGameLiftClientObject_DescribeGameSession_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UGameLiftClientObject, nullptr, "DescribeGameSession", nullptr, nullptr, sizeof(GameLiftClientObject_eventDescribeGameSession_Parms), Z_Construct_UFunction_UGameLiftClientObject_DescribeGameSession_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UGameLiftClientObject_DescribeGameSession_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UGameLiftClientObject_DescribeGameSession_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UGameLiftClientObject_DescribeGameSession_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UGameLiftClientObject_DescribeGameSessionPlacement_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UGameLiftClientObject, nullptr, "DescribeGameSessionPlacement", nullptr, nullptr, sizeof(GameLiftClientObject_eventDescribeGameSessionPlacement_Parms), Z_Construct_UFunction_UGameLiftClientObject_DescribeGameSessionPlacement_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UGameLiftClientObject_DescribeGameSessionPlacement_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UGameLiftClientObject_DescribeGameSessionPlacement_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UGameLiftClientObject_DescribeGameSessionPlacement_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UGameLiftClientObject_DescribeGameSessionQueues_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UGameLiftClientObject, nullptr, "DescribeGameSessionQueues", nullptr, nullptr, sizeof(GameLiftClientObject_eventDescribeGameSessionQueues_Parms), Z_Construct_UFunction_UGameLiftClientObject_DescribeGameSessionQueues_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UGameLiftClientObject_DescribeGameSessionQueues_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UGameLiftClientObject_DescribeGameSessionQueues_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UGameLiftClientObject_DescribeGameSessionQueues_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UGameLiftClientObject_SearchGameSessions_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UGameLiftClientObject, nullptr, "SearchGameSessions", nullptr, nullptr, sizeof(GameLiftClientObject_eventSearchGameSessions_Parms), Z_Construct_UFunction_UGameLiftClientObject_SearchGameSessions_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UGameLiftClientObject_SearchGameSessions_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UGameLiftClientObject_SearchGameSessions_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UGameLiftClientObject_SearchGameSessions_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UGameLiftClientObject_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UGameLiftClientObject_CreateGameLiftObject, "CreateGameLiftObject" }, // 4070493075
		{ &Z_Construct_UFunction_UGameLiftClientObject_CreateGameSession, "CreateGameSession" }, // 427622593
		{ &Z_Construct_UFunction_UGameLiftClientObject_CreatePlayerSession, "CreatePlayerSession" }, // 2654859192
		{ &Z_Construct_UFunction_UGameLiftClientObject_DescribeGameSession, "DescribeGameSession" }, // 3239094006
		{ &Z_Construct_UFunction_UGameLiftClientObject_DescribeGameSessionPlacement, "DescribeGameSessionPlacement" }, // 4099780896
		{ &Z_Construct_UFunction_UGameLiftClientObject_DescribeGameSessionQueues, "DescribeGameSessionQueues" }, // 3774053805
		{ &Z_Construct_UFunction_UGameLiftClientObject_SearchGameSessions, "SearchGameSessions" }, // 1438919847
		{ &Z_Construct_UFunction_UGameLiftClientObject_StartGameSessionPlacement, "StartGameSessionPlacement" }, // 1862075557
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UGameLiftClientObject, 2546032007);
